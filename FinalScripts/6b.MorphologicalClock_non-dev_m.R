#### 30.b Sheet Data - Male ####

## Filtered to just be those over 2 years 
...
male_clockData <- male_clockData %>% filter(AgeY >= 2)
...
# #### Writing Outputs ####
# write_csv(fullModelCoef, "OutputData/FinalModelData/SheetClock_Adults/m_fullModelCoef.csv")
# 
# write_csv(LOAOCV_predictions, "OutputData/FinalModelData/SheetClock_Adults/m_predictions.csv")
