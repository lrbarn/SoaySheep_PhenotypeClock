...
#### Setting up Data ####
maleData <- left_join(male_sample_z, BirthPheno_recode)
maleData$AgeY <- maleData$CapYear - maleData$BirthYear

maleData_all <- na.omit(maleData)

male_clockData <- maleData %>% 
  select(ID, AgeY,
         IgA.z, IgE.z, IgG.z,
         RTL.z,
...
#### Writing Outputs ####
#  write_csv(fullModelCoef, "OutputData/FinalModelData/BioAssayClock/m_fullModelCoef.csv")
# # 
#  write_csv(LOAOCV_predictions, "OutputData/FinalModelData/BioAssayClock/m_predictions.csv")
# # 
